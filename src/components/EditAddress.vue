<template>
  <el-dialog title="添加收货地址" :visible.sync="dialogFormVisible" width="600px">
    <el-form
      :model="ruleForm"
      :rules="rules"
      ref="ruleForm"
    ...
    >
      ...
      <el-form-item label="联系方式" prop="telephone">
        <el-input v-model="ruleForm.telephone" placeholder="请输入正确联系方式" style="width: 200px"></el-input>
      </el-form-item>
      ...
      <el-form-item label="收货地址" prop="address.area">
        <el-cascader v-model="ruleForm.address.area" :options="options"></el-cascader>
      </el-form-item>
